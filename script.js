...
async function carregarSupervisores() {
  ...
  renderCard("posit_mix_salty_sup", "Posit_Mix_Salty", "Meta_Mix_Salty", "perc_Mix_Salty", data);
  renderCard("posit_mix_foods_sup", "Posit_Mix_Foods", "Meta_Mix_Foods", "perc_Mix_Foods", data);
}
